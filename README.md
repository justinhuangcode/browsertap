...
[![CI](https://github.com/justinhuangcode/browsertap/actions/workflows/ci.yml/badge.svg)](https://github.com/justinhuangcode/browsertap/actions/workflows/ci.yml)
[![crates.io](https://img.shields.io/crates/v/browsertap-cli.svg?style=flat-square)](https://crates.io/crates/browsertap-cli)
...
```bash
cargo install browsertap-cli
cargo install browsertap-daemon
```

### Pre-built binaries

Download from [GitHub Releases](https://github.com/justinhuangcode/browsertap/releases):
